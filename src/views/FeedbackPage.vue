    ...
    <template #content>
      <div class="common-sub-header">
        ...
        <Dropdown
          ...
          :on-select="(option) => selectedFile = option"
        />
        ...
        <Dropdown
          ...
          :on-select="(option) => selectDateType = option"
        />
  ...
  data() {
    return {
      ...
      requestColumns: [
        ...
        {label: '담당자', field: 'manager', sortable: false},
        ...
        {
          label: '', field: 'resend', sortable: false, type: 'button', btnText: "재발송", onClick: (row) => {
            console.log(row)
          }
        },
      ],
