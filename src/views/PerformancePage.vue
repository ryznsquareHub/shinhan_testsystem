  ...
  <article class="page-area">
    <section>
      <div class="flex-btn-box" style="margin-bottom: 20px;">
        ...
        <BasicButton @click="openModal1" text="성능검사등록" />
      ...
      <Modal v-if="isModalOpen1" @close="closeModal1">
        ...
        <template #body>
          <div style="width: 600px" class="text-light modal-form">
            ...
            <div class="modal-form-select" style="display: inline-flex; grid-column: 1 / 3">
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        { label: "NO", field: "performanceResultIdx", sortable: false },
        {
          label: "등록일",
          field: "createDt",
          type: "date",
        ...
        { label: "비고", field: "notes", sortable: false },
        {
          ...
          sortable: false,
          type: "modify",
          onClickEdit: (row) => { this.openModal2() },
          onClickDelete: (row) => { console.log(row) }
        }
      ]
      ,
      rows: [
      ...
      tempDataDump:
      {
        ...
        "data": [
          {
            "performanceResultIdx": 302,
            "createDt": "2024-11-13",
            "taskChannel": "MTS",
            "docNo": "문서 30",
            "testName": "WEB TEST 30",
            "testResult": "실패",
            "uploader": "홍길동",
            "notes": "재시도 예정"
          },
